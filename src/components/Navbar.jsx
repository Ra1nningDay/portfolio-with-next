...
export default function Navbar() {
    ...
    return (
        <div
            className={`flex max-w-screen top-0 border-1 z-10 font-mono lg:flex-start justify-between flex-no-wrap fixed w-full py-5 items-center px-4 ${
                isScrolled || isToggle ? "bg-[#f2f2f2]" : "bg-transparent"
            }`}
        >
            <div className="container mx-auto">
                <div className="flex items-center justify-between gap-6">
                    ...
                    <Link href="/" className="me-5 lg:hidden">
                        <h1 className="text-2xl font-bold">🚀RainningDay</h1>
                    </Link>
                    <button
